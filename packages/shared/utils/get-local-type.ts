...
export function getLocalTypeForField(collection: string, field: string, fieldsStore: any, relationsStore: any): LocalType | null {
	...
	if (relations.length === 1) {
		...
		if (relation && relation.related_collection === 'directus_files') return 'file';
		if (relation && relation.collection === collection && relation.field === field) return 'm2o';
		return 'o2m';
	}
